    ...
    public class TMDbInitializer : CreateDatabaseIfNotExists<TMDbContext>
    {
        ...
        protected void InitDBData(TMDbContext db)
        {
            try
            {
                ...
                //功能維護管理
                catalogLevel01 = new Catalog { CatalogName = "功能維護管理", CatalogOrder = 11, Permission = "Catalog", IsMenu = true, Comment = "", IconClass = "fa fa-tasks", ParentCatalogId = null, Roles = new List<Role>() { superAdminRole, adminRole } };
                ...
                new List<Catalog> {
                    ...
                    new Catalog { CatalogName = "功能維護管理首頁", CatalogOrder = 2, Permission = "Catalog/Index", IsMenu = true, Comment = "", IconClass = "", ParentCatalog = catalogLevel01, Roles = new List<Role>() { superAdminRole, adminRole } },
                ...
                //工作日誌管理
                catalogLevel01 = new Catalog { CatalogName = "工作日誌管理", CatalogOrder = 20, Permission = "Diary", IsMenu = true, Comment = "", IconClass = "fa fa-file-text-o", ParentCatalogId = null, Roles = new List<Role>() { superAdminRole, adminRole, generalRole } };
                db.Catalogs.Add(catalogLevel01);
                new List<Catalog> {
                    ...
                    new Catalog { CatalogName = "工作日誌管理首頁", CatalogOrder = 2, Permission = "Diary/Index,IndexPost", IsMenu = true, Comment = "", IconClass = "", ParentCatalog = catalogLevel01, Roles = new List<Role>() { superAdminRole, adminRole, generalRole } },
                ...
                //使用者管理
                catalogLevel01 = new Catalog { CatalogName = "使用者管理", CatalogOrder = 12, Permission = "User", IsMenu = true, Comment = "", IconClass = "fa fa-user", ParentCatalogId = null, Roles = new List<Role>() { superAdminRole, adminRole } };
                db.Catalogs.Add(catalogLevel01);
                new List<Catalog> {
                    ...
                    new Catalog { CatalogName = "使用者管理首頁", CatalogOrder = 2, Permission = "User/Index,IndexPost", IsMenu = true, Comment = "", IconClass = "", ParentCatalog = catalogLevel01, Roles = new List<Role>() { superAdminRole, adminRole } },
                ...
                //角色管理
                catalogLevel01 = new Catalog { CatalogName = "角色管理", CatalogOrder = 10, Permission = "Role/Index", IsMenu = true, Comment = "", IconClass = "fa fa-users", ParentCatalogId = null, Roles = new List<Role>() { superAdminRole, adminRole } };
                db.Catalogs.Add(catalogLevel01);
                new List<Catalog> {
                    ...
                    new Catalog { CatalogName = "角色管理首頁", CatalogOrder = 2, Permission = "Role/Index", IsMenu = true, Comment = "", IconClass = "", ParentCatalog = catalogLevel01, Roles = new List<Role>() { superAdminRole, adminRole } },
                ...
                //匯入管理
                catalogLevel01 = new Catalog { CatalogName = "匯入管理", CatalogOrder = 30, Permission = "Export/Index", IsMenu = true, Comment = "", IconClass = "glyphicon glyphicon-export", ParentCatalogId = null, Roles = new List<Role>() { superAdminRole, adminRole } };
                db.Catalogs.Add(catalogLevel01);
                new List<Catalog> {
                ...
                //圖表
                catalogLevel01 = new Catalog { CatalogName = "圖表管理", CatalogOrder = 31, Permission = "Chart/Index", IsMenu = true, Comment = "", IconClass = "fa fa-bar-chart-o", ParentCatalogId = null, Roles = new List<Role>() { superAdminRole, adminRole, generalRole } };
                db.Catalogs.Add(catalogLevel01);
                new List<Catalog> {
                    new Catalog { CatalogName = "個人工作統計圖", CatalogOrder = 1, Permission = "Chart/DiaryChart,DiaryChartPost", IsMenu = true, Comment = "", IconClass = "", ParentCatalog = catalogLevel01, Roles = new List<Role>() { superAdminRole, adminRole, generalRole } },
                    new Catalog { CatalogName = "搜尋工作統計權限", CatalogOrder = 2, Permission = "Chart/SearchDiaryChart", IsMenu = false, Comment = "", IconClass = "", ParentCatalog = catalogLevel01, Roles = new List<Role>() { superAdminRole, adminRole } },
                }.ForEach(o => db.Catalogs.Add(o));
